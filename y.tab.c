...
static const yytype_int8 yyrhs[] =
{
      ...
      20,    -1,    24,    -1,    21,    -1,     5,    13,    -1,    13,
      12,    22,    -1,     4,     6,    13,    11,     8,    23,     9,
       7,    -1,     4,     6,    13,    11,     8,     9,     7,    -1,
      14,    -1,    23,    10,    14,    -1,     3,    15,    -1,     3,
      13,    -1
};
...
{
       0,    35,    35,    58,    63,    69,    70,    71,    74,    83,
      91,   116,   130,   172,   183,   190
};
#endif
...
{
  "$end", "error", "$undefined", "WRITE", "POSICION", "READ", "PARA",
  "PARC", "CA", "CC", "COMA", "PYC", "ASIGNA", "ID", "CTE", "CTE_S",
  "$accept", "s", "prog", "sent", "read", "asig", "posicion", "lista",
  "write", 0
};
#endif
...
{
       0,     0,     0,     0,     0,     2,     3,     5,     7,     6,
      15,    14,     8,     0,     1,     4,     0,     9,     0,     0,
       0,     0,     0,    12,     0,    11,     0,     0,    10,    13
};
...
{
      -3,   -10,    -9,    -1,     9,    -3,   -11,   -11,   -11,   -11,
     -11,   -11,   -11,     8,   -11,   -11,     7,   -11,     1,     4,
      10,    -8,    12,   -11,    -2,   -11,    13,     2,   -11,   -11
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -11,   -11,   -11,    16,   -11,   -11,   -11,   -11,   -11
};
...
{
       1,    22,     2,    10,    12,    11,    23,    26,    27,    14,
       3,    13,    16,    18,    19,    20,    29,     0,    21,    25,
      28,    15
};

static const yytype_int8 yycheck[] =
{
       3,     9,     5,    13,    13,    15,    14,     9,    10,     0,
      13,    12,     4,     6,    13,    11,    14,    -1,     8,     7,
       7,     5
};
...
{
       0,     3,     5,    13,    17,    18,    19,    20,    21,    24,
      13,    15,    13,    12,     0,    19,     4,    22,     6,    13,
      11,     8,     9,    14,    23,     7,     9,    10,     7,    14
};
...
#line 75 "./EA3.y"
	...
	insertar_polaca((yyvsp[(2) - (2)].string), &numeracion, &polaca);
}
    break;
...
#line 84 "./EA3.y"
	...
	operacion_asignacion((yyvsp[(1) - (3)].string), VAR_POS, &numeracion, &polaca);
}
    break;
...
#line 92 "./EA3.y"
	...
	cambiar_elemento(&polaca, _nro_celda_aux, (yyvsp[(3) - (8)].string));
}
    break;
...
#line 131 "./EA3.y"
	...
	algoritmo_busqueda_aparicion((yyvsp[(1) - (1)].string), &_contador, &numeracion, &polaca);
}
    break;
...
#line 173 "./EA3.y"
	...
	algoritmo_busqueda_aparicion((yyvsp[(3) - (3)].string), &_contador, &numeracion, &polaca);
...
#line 184 "./EA3.y"
	...
	operacion_output((yyvsp[(2) - (2)].string), &numeracion, &polaca);
}
    break;
